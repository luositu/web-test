  ...
  private attackCases: AttackCase[] = [
    {
      ...
      serviceType: "IM",
      apiInterface: "发送消息",
      parameters: '{"targetUserId": "user123", "message": "紧急：财务系统升级，请立即验证账户", "messageType": "text"}',
      type: "私聊文本",
      status: "active",
    ...
    },
    {
      ...
      serviceType: "IM",
      apiInterface: "发送消息",
      parameters: '{"targetUserId": "group456", "message": "LinkedIn联系邀请，点击查看职业机会", "messageType": "text"}',
      type: "群聊文本",
      status: "paused",
    ...
    },
    {
      ...
      serviceType: "IM",
      apiInterface: "发送文件",
      parameters: '{"targetUserId": "user789", "fileUrl": "https://example.com/report.pdf", "fileName": "年度报告.pdf"}',
      type: "私聊图片",
      status: "completed",
    ...
    },
    {
      ...
      serviceType: "HTTP",
      apiInterface: "用户登录",
      parameters: '{"username": "test_user", "password": "weak_password123"}',
      type: "登录",
      status: "active",
      description: "测试用户登录接口的安全性",
      attackCount: 1,
      qps: 60,
      targetCount: 32,
      successRate: 28.1,
    ...
    },
    {
      ...
      serviceType: "HTTP",
      apiInterface: "用户注册",
      parameters: '{"username": "new_user", "password": "password123", "email": "test@example.com"}',
      type: "注册",
      status: "draft",
      description: "测试用户注册接口功能",
      attackCount: 1,
      qps: 60,
      targetCount: 15,
      successRate: 0,
    ...
    },
    {
      ...
      serviceType: "HTTP",
      apiInterface: "获取用户信息",
      parameters: '{"userId": "12345", "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."}',
      type: "登录",
      status: "active",
    ...
    },
    {
      ...
      serviceType: "IM",
      apiInterface: "创建群组",
      parameters: '{"groupName": "测试群组", "memberIds": ["user1", "user2", "user3"]}',
      type: "注册",
      status: "paused",
      description: "测试群组创建功能",
      attackCount: 1,
      qps: 60,
      targetCount: 25,
      successRate: 42.1,
